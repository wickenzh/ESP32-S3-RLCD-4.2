...
inline constexpr int kSettingsTimeoutMs = 30000;
inline constexpr int kHistoryPageTimeoutMs = 5 * 60 * 1000;
...
inline constexpr int kSettingsManualSyncTimeoutMs = 60000;
inline constexpr int kWeatherClockAutoRetryMs = 2 * 60 * 1000;
inline constexpr int kWeatherClockAutoSyncMaxAttempts = 3;
inline constexpr int kWeatherClockAutoBackoffMs = 30 * 60 * 1000;
...
inline constexpr int kHttpDefaultTimeoutMs = 10000;
...
inline constexpr int kOtaHttpTimeoutMs = 8000;
inline constexpr int kOtaNoProgressTimeoutMs = 45000;
inline constexpr int kOtaMaxDownloadMs = 10 * 60 * 1000;
inline constexpr int kOtaStatusMinIntervalMs = 3000;
...
inline constexpr int kBatteryChargingSampleMs = 60 * 1000;
...
extern lv_obj_t *g_info_labels[5];
